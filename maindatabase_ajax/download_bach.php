...
<div class="container py-5">
    <div class="glass-card p-5">
        ...
        <div id="progressSection" class="d-none">
            ...
            <p class="text-muted mb-4"><span id="current">0</span> / <span id="total">0</span> records • Part <span id="part">1</span></p>
...
function startExport(offset) {
    ...
    $.post('export_batch.php', { offset: offset, limit: batchSize }, function(res) {
        if (res.success) {
            ...
            const fileName = 'MAINDATABASE_part_' + part + '_(' + current.toLocaleString() + 'rows).csv';
            ...
            if (current < total) {
                ...
                $('#startExport').html('<i class="bi bi-check2-all"></i> Complete!');
