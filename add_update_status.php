        ...
        if ($minID <= 0 || $maxID <= 0 || $maxID < $minID) {
            ...
            if ($stmt = mysqli_prepare($link, $sql)) {
                ...
                if ($ok) {
                    ...
                    log_activity($link, $userId, 'BULK UPDATE', $details, $affectedIds);
...
<section class="hero">
    <div class="container-narrow">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="mt-2">
                <a href="data_management_temporary.php" class="btn btn-light btn-sm">View All Temporary Records</a>
            </div>
        </div>
    </div>
</section>
...
<div class="container-narrow mt-4">
    ...
    <div class="text-center mt-4 mb-5">
        <a href="data_management_temporary.php" class="btn btn-outline-primary">Open Temporary Database Viewer</a>
    </div>
</div>
