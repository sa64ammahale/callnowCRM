...
DROP TABLE IF EXISTS `api_database_assignments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `api_database_assignments` (
...
DROP TABLE IF EXISTS `user_page_filters`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_page_filters` (
...
INSERT INTO `roles` VALUES (1,'Admin','Full system access — all permissions.',1,'2026-07-15 19:08:36'),(2,'Manager','Manages teams, users, leads, and data operations.',1,'2026-07-15 19:08:36'),(3,'Supervisor','Oversees team leads and reports.',1,'2026-07-15 19:08:36'),(4,'Officer','Basic lead management only.',1,'2026-07-15 19:08:36');
...
INSERT INTO `app_settings` VALUES (1,'app_name','CallNow CRM','Application display name',NULL,'2026-07-15 16:44:04'),(2,'company_name','CallNow','Default company name',NULL,'2026-07-15 16:44:04'),(3,'default_lead_status','LEAD','Default status for new leads',NULL,'2026-07-15 16:44:04'),(4,'default_lead_stage','Cold','Default stage for new leads',NULL,'2026-07-15 16:44:04'),(5,'pagination_size','50','Default records per page',NULL,'2026-07-15 16:44:04'),(6,'session_timeout','30','Session timeout in minutes',NULL,'2026-07-15 16:44:04'),(7,'enable_export','1','Enable data export (1=yes, 0=no)',NULL,'2026-07-15 16:44:04'),(8,'timezone','Asia/Kolkata','System timezone',NULL,'2026-07-15 16:44:04'),(16,'rbac_cache_version','7',NULL,NULL,'2026-07-16 17:34:23'),(17,'rbac_initialized','1',NULL,NULL,'2026-07-16 13:07:51');
...
INSERT INTO `api_settings` VALUES (1,'api_enabled','1','Enable/disable mobile API access globally','2026-07-18 11:05:30'),(2,'rate_limit_per_minute','60','Requests per minute per user (0 = unlimited)','2026-07-18 11:05:30'),(3,'rate_limit_per_hour','1000','Requests per hour per user (0 = unlimited)','2026-07-18 11:05:30'),(4,'token_expiry_days','90','Default token expiry in days (0 = never)','2026-07-18 11:05:30'),(5,'allowed_databases','[\"temporary\",\"leads\"]','JSON array of allowed database types: temporary, main, leads','2026-07-18 11:05:30'),(6,'require_team_assignment','1','Require team assignment for database access','2026-07-18 11:05:30'),(7,'log_requests','1','Log all API requests for audit','2026-07-18 11:05:30');
