...
CREATE TABLE LEADS_TABLE (
    ...
    lead_status_new ENUM('FOLLOWUP','LEAD','LOGIN','UNDERWRTING','SANCTIONED','DISBURSED') NOT NULL DEFAULT 'LEAD',
    ...
    INDEX idx_lead_status_new (lead_status_new),
    INDEX idx_login_bank_name (login_bank_name),
